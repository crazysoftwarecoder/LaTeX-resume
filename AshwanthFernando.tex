...
\begin{document}
    ...
    \section{Experience}
        \vspace{0.15 cm}
        \begin{twocolentry}{
            Feb 2022 - Present Day
        }
        \textbf{Principal Consultant}, Atlassian, WEX, Coles, Macquarie Bank\end{twocolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Pioneered a priority/vip tagging system for Shopify feeds, improving shipping times for priority orders by 140\%.
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Drove cloud infrastructure modernization efforts across a large-scale fleet, earning two patents and decreasing deployment cycles significantly.

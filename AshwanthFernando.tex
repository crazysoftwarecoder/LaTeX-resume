...
\begin{document}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{adjustwidth}{0.5cm}{0cm}
            \textit{AI-driven distribution platform specializing in logistics solutions for e-commerce brands, offering order fulfillment, delivery, and supply chain consulting to enhance operational efficiency and scalability for online retailers.}
            \end{adjustwidth}
            
            \vspace{0.10 cm}
            \begin{highlights}
                \item Drove the end-to-end technical strategy for the distributed reverse logistics platform, collaborating closely with PMs and Founders on architectural decisions, requirements and milestones.

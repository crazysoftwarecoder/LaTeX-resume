...
\begin{document}
    ...
    \section{Work Rights}
        ...
        \end{onecolentry}
        \begin{onecolentry}
            \textbf{United States of America}: E3 visa, no quota, unlimited renewals, no sponsorship needed.
        \end{onecolentry}
        \begin{onecolentry}
            \textbf{United Kingdom}: Global Talent - Exceptional Talent visa for the UK.
        \end{onecolentry}
    \section{Skills}
        \begin{onecolentry}
            \textbf{Languages:} Java | GoLang | Scala | NodeJS
        \end{onecolentry}
        \begin{onecolentry}
            \textbf{Databases} MySQL | PostgreSQL | DynamoDB
        \end{onecolentry}
        \begin{onecolentry}
            \textbf{CLOUD:} AWS EC2 | Elasticache | SNS | SQS | RDS | Dataform | Terraform | Jenkins
        \end{onecolentry}
        \begin{onecolentry}
            \textbf{MISCELLANEOUS:} Spring | Protobuf | GoMock | Gorm | JPA | Redis | Zookeeper | Kafka | GraphQL | grpc
        \end{onecolentry}
        \begin{onecolentry}
    ...
    \section{Experience}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Lead Software Engineer}, Packsmith\end{twocolentry}

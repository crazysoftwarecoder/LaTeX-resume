...
\newif\ifAustralia
\Australiafalse % Set to false for Global version
...
\titlespacing{\section}{
    ...
    % top space:
    0.8 cm  % Increased from 0.3cm
}{
    % bottom space:
    0.5 cm  % Increased from 0.2cm
} % section title spacing

\renewcommand\labelitemi{$\vcenter{\hbox{\small$\bullet$}}$} % custom bullet points
\newenvironment{highlights}{
    \begin{itemize}[
        topsep=0.20 cm,     % Increased from 0.10cm
        parsep=0.20 cm,     % Increased from 0.10cm
        partopsep=0pt,
        itemsep=0.15cm,     % Increased from 0pt
...
\begin{document}
    ...
    \begin{header}
        ...
        \vspace{10 pt} % Increased from 5pt
    ...
    \vspace{10 pt} % Increased from 5pt - 0.3cm

    \section{Work Rights}
        \vspace{0.1cm} % Added spacing
        \begin{onecolentry}
            \ifAustralia
                \textbf{Australia}: Australian Citizen
            \else
                \textbf{Australia}: Australian Citizen \\
                \vspace{0.05cm} % Added small spacing between lines
                ...
                \vspace{0.05cm} % Added small spacing between lines
                \textbf{UK}: Global Talent Exceptional Stream Visa
            \fi
        \end{onecolentry}
        
    \vspace{0.3cm} % Added extra spacing between sections
    ...
    \section{Skills}
        ...
        \end{onecolentry}
        \vspace{0.15cm} % Added spacing between skill items
        \begin{onecolentry}
    ...
    \section{Experience}
        ...
        \vspace{0.35 cm} % Increased from 0.15cm
        \begin{twocolentry}{
            Jul 2024 – Nov 2024
        }
        ...
        \vspace{0.40 cm} % Increased from 0.20cm
        \begin{twocolentry}{
            Oct 2010 - Sep 2013
        }
        ...
        \vspace{0.4cm} % Added extra spacing

    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            ...
            \begin{itemize}[
                ...
                \item Contributed significantly to a multi-agent mortgage assessment pipeline using \textbf{LangGraph} with \textbf{RAG}, orchestrating document verification, serviceability analysis, compliance checks, and product recommendation agents, reducing broker pre-approval turnaround from \textbf{days to under 2 hours} while ensuring \textbf{APRA regulatory compliance}.
